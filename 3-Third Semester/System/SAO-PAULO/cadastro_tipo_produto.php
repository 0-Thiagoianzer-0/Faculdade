...
<html lang="en">
    <head>
        <title>Cadastro de Tipo Produto</title>
        <meta charset="utf-8">
        ...
        <script src="js/tipo_produto/salva_altera_tipo_produto.js"></script>
        <script src="js/tipo_produto/monta_select_tipo_produto.js"></script>
        <script src="js/tipo_produto/busca_tipo_produtoAjax.js"></script>
		<script src="js/tipo_produto/limpa_tipo_produto.js"></script>
        <script>
    ...
    <body onload="limpar();">
		...
		<div class="container" style="background-color: white; border-radius: 15px; width: 1200px;">
			<div style="margin-top: 20px;">
				<h3>Cadastro de Tipo Produto</h3>
			</div>
			<form id="formTipoProduto" name="formTipoProduto" method="POST">
				<div class="form-row">
					<div class="form-group col-md-1" style="margin-top: 10px;">
						...
						<input 
							type="text"
							class="form-control"
							id="txtCodigoTipoProduto"
							style="text-transform:uppercase;"
							value="<?php
										$sql = "SELECT MAX(codigo_tipo_produto) FROM tipo_produto";
										$resultado = pg_query($conexao, $sql);
										$registro = pg_fetch_row($resultado);
										$txtCodigoTipoProduto = $registro[0] + 1;
										echo ($txtCodigoTipoProduto);
									?>"
							disabled
						/>
					</div>
					<div class="form-group col-md-1" style="margin-top: 3.5%; margin-left: 9%;" id="divBotao">
						<input 
							type="button" 
							onclick="mostrarCombo();lista_tipo_produto();"
				...
				<div class="form-row">
					<div class="form-group col-md-4" style="margin-top: 10px; display: none;" id="divBuscar">
						<label>Busca Tipo Produto:</label>
						<select 
							class="form-control" 
							id="cmbTipoProduto"
							onchange="busca_tipo_produtoAjax();"
							onkeyup="busca_tipo_produtoAjax();"
							onkeydown="busca_tipo_produtoAjax();">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-2" style="margin-top: 10px;">
						<button type="button" class="btn btn-success btn-md btn-block" onClick="salvatipoproduto();">Salvar</button>
					</div>
				</div>
			</form>
        </div>
