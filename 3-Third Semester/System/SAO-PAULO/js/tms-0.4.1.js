					...
					anims: {			
						...
						pbchFu:function(){
							...
							if(_.prog==0)
								...
								_.progressBar
									.stop()
									.animate({width:_.prog/4000*_.progressBar.parent().width()},{easing:'linear',duration:_.slideshow/100})
									//AQUI MECHEMOS NA PORCENTAGEM DE AUMENTO DE TAMANHO DA PROGRESS BAR
						},
